...
const PotasioNPK = ({ isCustomLineColors = false, isDashboard = false }) => {
  ...
  const datosFetch = async () => {
    const response = await fetch(
      "https://api.thingspeak.com/channels/2305213/fields/7.json?results=13"
    );
          ...
          data={[
            {
              ...
              data: dataTemp
              .filter((singleData) => !isNaN(singleData.field7)) // Filtrar valores no numéricos
              .map((singleData) => {
