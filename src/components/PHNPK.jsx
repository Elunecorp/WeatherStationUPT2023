...
const PHNPK = ({ isCustomLineColors = false, isDashboard = false }) => {
  ...
  const datosFetch = async () => {
    const response = await fetch(
      "https://api.thingspeak.com/channels/2305213/fields/4.json?results=13"
    );
          ...
          data={[
            {
              ...
              data: dataTemp
              .filter((singleData) => !isNaN(singleData.field4)) // Filtrar valores no numéricos
              .map((singleData) => {
