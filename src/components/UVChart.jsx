...
const UVChart = ({ isCustomLineColors = false, isDashboard = false }) => {
  ...
  const datosFetch = async () => {
    const response = await fetch(
      "https://api.thingspeak.com/channels/2263691/fields/5.json?results=13"
    );
          ...
          data={[
            {
              ...
              color: tokens("dark").blueAccent[300],   //DATATEMP FILTER
